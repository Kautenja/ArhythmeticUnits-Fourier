...
struct SpectrumAnalyzerSIMD : rack::Module {
 public:
...
struct SpectrumAnalyzerDisplaySIMD : rack::TransparentWidget {
 private:
    ...
    SpectrumAnalyzerSIMD* module = nullptr;
 ...
 public:
    ...
    ///
    explicit SpectrumAnalyzerDisplaySIMD(SpectrumAnalyzerSIMD* module_) :
...
struct SpectrumAnalyzerSIMDWidget : ThemedWidget<BASENAME> {
    /// @brief Create a new spectrum analyzer widget.
    ///
    /// @param module The back-end module to interact with. Can be a nullptr.
    ///
    explicit SpectrumAnalyzerSIMDWidget(SpectrumAnalyzerSIMD* module = nullptr) : ThemedWidget<BASENAME>() {
        setModule(module);
        // Screws
        ...
        for (std::size_t i = 0; i < SpectrumAnalyzerSIMD::NUM_CHANNELS; i++) {
            addInput(createInput<PJ301MPort>(Vec(11, 30 + 75 * i), module, SpectrumAnalyzerSIMD::INPUT_SIGNAL + i));
            addParam(createParam<Trimpot>(Vec(13, 66 + 75 * i), module, SpectrumAnalyzerSIMD::PARAM_INPUT_GAIN + i));
        }
        // Buttons.
        addParam(createParamCentered<PB61303>(Vec(8 + 15, 331 + 15), module, SpectrumAnalyzerSIMD::PARAM_RUN));
        addChild(createLightCentered<PB61303Light<WhiteLight>>(Vec(8 + 15, 331 + 15), module, SpectrumAnalyzerSIMD::LIGHT_RUN));
        // Screen.
        SpectrumAnalyzerDisplaySIMD* display = new SpectrumAnalyzerDisplaySIMD(module);
        ...
        auto window_function_param = createParam<WindowFunctionTextKnob>(Vec(50 + 0 * 66, 330), module, SpectrumAnalyzerSIMD::PARAM_WINDOW_FUNCTION);
        ...
        auto window_length_param = createParam<WindowLengthTextKnob>(Vec(50 + 1 * 66, 330), module, SpectrumAnalyzerSIMD::PARAM_WINDOW_LENGTH);
        window_length_param->maxAngle = 1.2f * M_PI;
        addParam(window_length_param);
        // Hop length control.
        addParam(createParam<TextKnob>(Vec(50 + 2 * 66, 330), module, SpectrumAnalyzerSIMD::PARAM_HOP_LENGTH));
        // Frequency scale control with custom angles to match discrete range.
        auto frequency_scale_param = createParam<FrequencyScaleTextKnob>(Vec(50 + 3 * 66, 330), module, SpectrumAnalyzerSIMD::PARAM_FREQUENCY_SCALE);
        ...
        auto magnitude_scale_param = createParam<MagnitudeScaleTextKnob>(Vec(50 + 4 * 66, 330), module, SpectrumAnalyzerSIMD::PARAM_MAGNITUDE_SCALE);
        magnitude_scale_param->maxAngle = 0.6 * M_PI;
        addParam(magnitude_scale_param);
        // Time smoothing control.
        addParam(createParam<TextKnob>(Vec(50 + 5 * 66, 330), module, SpectrumAnalyzerSIMD::PARAM_TIME_SMOOTHING));
        // Frequency smoothing control with custom angles to match discrete range.
        auto frequency_smoothing_param = createParam<FrequencySmoothingTextKnob>(Vec(50 + 6 * 66, 330), module, SpectrumAnalyzerSIMD::PARAM_FREQUENCY_SMOOTHING);
        ...
        addParam(createParam<TextKnob>(Vec(50 + 7 * 66, 330), module, SpectrumAnalyzerSIMD::PARAM_LOW_FREQUENCY));
        addParam(createParam<TextKnob>(Vec(50 + 8 * 66, 330), module, SpectrumAnalyzerSIMD::PARAM_HIGH_FREQUENCY));
        // Slope (dB/octave @1000Hz) controls.
        addParam(createParam<TextKnob>(Vec(50 + 9 * 66, 330), module, SpectrumAnalyzerSIMD::PARAM_SLOPE));
    }
    ...
    void appendContextMenu(Menu* menu) override {
        ...
        SpectrumAnalyzerSIMD* const module = dynamic_cast<SpectrumAnalyzerSIMD*>(this->module);
...
Model* modelSpectrumAnalyzerSIMD = createModel<SpectrumAnalyzerSIMD, SpectrumAnalyzerSIMDWidget>("SpectrumAnalyzerSIMD");
